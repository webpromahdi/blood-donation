...
export default function Notifications() {
  ...
  const handleNotificationClick = async (n) => {
    ...
    const route = getNotificationRoute(n, 'donor')
    navigate(route)
  }
          ...
          filtered.map((n) => {
            ...
            return (
              <div
                ...
                className={`flex cursor-pointer items-start gap-4 rounded-md border border-gray-200 p-4 hover:bg-gray-50 dark:border-slate-700 dark:hover:bg-slate-700/50 ${
                  unread
