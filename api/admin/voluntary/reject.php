...
try {
    ...
    // D10: Notify donor their voluntary donation was rejected using NotificationService
    $notificationService = new NotificationService($conn);
    $notificationService->notifyDonorVoluntaryRejected($voluntary['donor_user_id'], $input['voluntary_id'], $reason);
